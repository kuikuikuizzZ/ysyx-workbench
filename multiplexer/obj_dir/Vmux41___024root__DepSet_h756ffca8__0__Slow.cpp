...
VL_ATTR_COLD void Vmux41___024root___eval_initial__TOP(Vmux41___024root* vlSelf) {
    ...
    // Body
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__key_list[0U] = 3U;
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__key_list[1U] = 2U;
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__key_list[2U] = 1U;
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__key_list[3U] = 0U;
}
...
VL_ATTR_COLD void Vmux41___024root___ctor_var_reset(Vmux41___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__pair_list[__Vi0] = VL_RAND_RESET_I(4);
    }
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__key_list[__Vi0] = VL_RAND_RESET_I(2);
    }
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__data_list[__Vi0] = VL_RAND_RESET_I(2);
    }
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__lut_out = VL_RAND_RESET_I(2);
    vlSelf->mux41__DOT__muxkey41__DOT__i0__DOT__hit = VL_RAND_RESET_I(1);
