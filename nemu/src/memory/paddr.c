...
static void out_of_bound(paddr_t addr) {
  ...
  IFDEF(CONFIG_YSYXSOC, panic("address = " FMT_PADDR " is out of bound of pmem [" FMT_PADDR ", " FMT_PADDR "], sdram:" FMT_PADDR ", psram:" FMT_PADDR ",flash:" FMT_PADDR ",sram:" FMT_PADDR ",mrom:" FMT_PADDR " at pc = " FMT_WORD, 
    addr, PMEM_LEFT, PMEM_RIGHT, 0x10000000,0x10000000,
    CONFIG_FLASH_BASE,CONFIG_SRAM_BASE,CONFIG_MROM_BASE, cpu.pc));
  IFNDEF(CONFIG_YSYXSOC, panic("address = " FMT_PADDR " is out of bound of pmem [" FMT_PADDR ", " FMT_PADDR "] at pc = " FMT_WORD,
