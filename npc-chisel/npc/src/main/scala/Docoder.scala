...
class ysyx_24100012_Decoder(implicit val conf: ysyx_24100012_Config) extends Module
{
   ...
   val mem_inst_is_load = io.mem_ctl.inst_is_load
   ...
   stall := ((exe_inst_is_load) && (io.exe_ctl.wbaddr === dec_rs1_addr) && (io.exe_ctl.wbaddr =/= 0.U) && dec_rs1_oen) ||
            ((exe_inst_is_load) && (io.exe_ctl.wbaddr === dec_rs2_addr) && (io.exe_ctl.wbaddr =/= 0.U) && dec_rs2_oen) ||
            ((mem_inst_is_load) && (io.mem_ctl.wbaddr === dec_rs1_addr) && (io.mem_ctl.wbaddr =/= 0.U) && dec_rs1_oen) ||
            ((mem_inst_is_load) && (io.mem_ctl.wbaddr === dec_rs2_addr) && (io.mem_ctl.wbaddr =/= 0.U) && dec_rs2_oen) ||
            (io.exe_ctl.is_csr) 
