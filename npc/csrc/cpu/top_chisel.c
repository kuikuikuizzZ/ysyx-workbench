...
uint32_t top_decode_pc() {
    if (!_rootp) return 0;
    uint32_t decode_pc ;
    IFDEF(CONFIG_SOC,decode_pc=(uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__regBits_1_pc);
...
uint32_t top_alu_out() {
    if (!_rootp) return 0;
    uint32_t alu_out;
    IFDEF(CONFIG_SOC,alu_out=(uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__regBits_2_alu_out);
    return alu_out;
...
uint32_t top_op1() {
    if (!_rootp) return 0;
    uint32_t op1=0;
    IFDEF(CONFIG_SOC,op1=(uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__regBits_1_op1_data);
...
uint32_t top_op2() {
    if (!_rootp) return 0;
    uint32_t op2 =0;
    IFDEF(CONFIG_SOC,op2=(uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__regBits_1_op2_data);
