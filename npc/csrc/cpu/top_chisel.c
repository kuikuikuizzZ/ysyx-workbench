...
uint32_t top_gpr(int i) {
    ...
    IFDEF(CONFIG_GALOIS,pc=top_decode_pc())
...
uint32_t top_pc() {
    ...
    IFDEF(CONFIG_SOC,return (uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__decoder_io_ifu_dec_bits_rpc);
