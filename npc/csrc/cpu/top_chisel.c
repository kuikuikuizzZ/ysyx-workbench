...
#ifdef CONFIG_GALOIS
    uint32_t mtvec      = _rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__exu__DOT__csr_files__DOT__csr__DOT__reg_mtvec;
    uint32_t mstatus    = _rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__exu__DOT__csr_files__DOT__csr__DOT__reg_mstatus;
    uint32_t mepc       = _rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__exu__DOT__csr_files__DOT__csr__DOT__reg_mepc;
    uint32_t mcause     = _rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__exu__DOT__csr_files__DOT__csr__DOT__reg_mcause;
...
uint32_t top_decode_pc() {
    if (!_rootp) return 0;
    uint32_t decode_pc ;
    IFDEF(CONFIG_GALOIS, return (uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__decoder_io_ifu_dec_bits_rinstA_pc;)
