...
uint32_t top_gpr(int i) {
    ...
    IFNDEF(CONFIG_SOC,gpr_i=(uint32_t)_rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__reg_file__DOT__regfile_mem_ext__DOT__Memory[i]);
    return gpr_i;
}
...
#else 
    uint32_t mstatus    = _rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu__DOT__csr_files__DOT__csr__DOT__reg_mstatus;
    uint32_t mtvec      = _rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu__DOT__csr_files__DOT__csr__DOT__reg_mtvec;
    uint32_t mepc       = _rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu__DOT__csr_files__DOT__csr__DOT__reg_mepc;
    uint32_t mcause     = _rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu__DOT__csr_files__DOT__csr__DOT__reg_mcause;
    uint32_t mtval      = _rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu__DOT__csr_files__DOT__csr__DOT__reg_mtval;
#endif
...
uint32_t top_pc() {
    if (!_rootp) return 0;
    uint32_t tpc ;
    IFNDEF(CONFIG_DIFFTEST,IFDEF(CONFIG_SOC,tpc=(uint32_t)_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__core__DOT__inst_fetch__DOT__pc_reg));
    IFNDEF(CONFIG_DIFFTEST,IFNDEF(CONFIG_SOC,tpc=(uint32_t)_rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__inst_fetch__DOT__pc_reg;))
...
uint32_t top_alu_out() {
    ...
    IFNDEF(CONFIG_SOC,alu_out=(uint32_t)_rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__lsu_io_exe_mem_bits_ralu_out);
    return alu_out;
}
...
uint32_t top_op1() {
    ...
    IFNDEF(CONFIG_SOC,op1=(uint32_t)_rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__exu_io_dec_exe_bits_rop1_data);
    return op1;
}
...
uint32_t top_op2() {
    ...
    IFNDEF(CONFIG_SOC,op2=(uint32_t)_rootp->ysyxSoCFull__DOT__core__DOT__core__DOT__exu_io_dec_exe_bits_rop2_data);
    return op2;
}
void watch_top(){
