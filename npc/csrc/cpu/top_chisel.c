...
uint32_t top_gpr(int i) {
    ...
    uint32_t gpr_i ;
    IFDEF(CONFIG_SOC,gpr_i=(uint32_t)_rootp->_rootp->_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__reg_file__DOT__regfile_ext__DOT__Memory[i];);
...
uint32_t top_pc() {
    if (!_rootp) return 0;
    uint32_t pc ;
    IFDEF(CONFIG_SOC,pc=(uint32_t)_rootp->_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__inst_fetch__DOT__pc_reg;);
...
uint32_t top_dnpc() {
    if (!_rootp) return 0;
    uint32_t pc;
    IFDEF(CONFIG_SOC,pc=_(uint32_t)rootp->_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__inst_fetch__DOT__casez_tmp;);
...
uint32_t top_op1() {
    if (!_rootp) return 0;
    uint32_t op1;
    IFDEF(CONFIG_SOC,op1=(uint32_t)_rootp->_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__d__DOT__casez_tmp_0;);
...
uint32_t top_op2() {
    if (!_rootp) return 0;
    uint32_t op2;
    IFDEF(CONFIG_SOC,op2=(uint32_t)_rootp->_rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__d__DOT__casez_tmp_1;);
